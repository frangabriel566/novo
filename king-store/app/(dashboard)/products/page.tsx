...
export default function ProductsPage() {
  ...
  function openEdit(product: Product) { setEditProduct(product); setModalOpen(true) }
  ...
  return (
    <div>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editProduct ? 'Editar Produto' : 'Novo Produto'}>
        <ProductForm product={editProduct} onSuccess={() => { setModalOpen(false); loadProducts() }} onCancel={() => setModalOpen(false)} />
      </Modal>
