  ...
  return (
    <div>
      <Header
        ...
        actions={<Link href="/sales/new"><Button><Plus className="w-4 h-4" />Nova Venda</Button></Link>}
      />
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
          {loading ? <PageLoader /> : sales.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-gray-500 gap-3">
              ...
              <Link href="/sales/new"><Button size="sm"><Plus className="w-4 h-4" />Criar venda</Button></Link>
            </div>
          ) : (
            <>
              {/* Mobile cards */}
